...
export const metadata = {
  title: "Invictus AI - Standard Edition",
...
export default function StandardBrochure() {
  return (
    <div className="min-h-screen bg-gray-100 py-10 print:py-0 print:bg-white text-bond-navy font-sans">
      ...
      <A4Page>
        ...
        <div className="my-auto">
          <h1 className="text-5xl font-black leading-tight tracking-tight mb-6">
            ...
            <span className="text-bond-purple">Digital Storefront</span>
          </h1>
          <p className="text-2xl text-gray-600 mb-12">
            Professional, high-speed websites designed specifically for modern dental practices.
          </p>

          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold mb-6">What We Deliver (Standard Edition):</h2>
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <CheckCircle2 className="text-bond-lime" size={28} />
                <span className="text-xl">Custom Standard Design (Optimized for Conversions)</span>
              </div>
              <div className="flex items-center gap-4">
                <CheckCircle2 className="text-bond-lime" size={28} />
                <span className="text-xl">Essential SEO Setup (Rank Locally)</span>
              </div>
              <div className="flex items-center gap-4">
                <CheckCircle2 className="text-bond-lime" size={28} />
              ...
              <div className="flex items-center gap-4">
                <CheckCircle2 className="text-bond-lime" size={28} />
                <span className="text-xl">Patient Contact & Booking Forms</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <A4Page className="bg-slate-50">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-black">Standard Themes</h2>
      ...
      <A4Page>
        <div className="flex-1 flex flex-col items-center pt-8">
          <h2 className="text-4xl font-black mb-10 text-bond-navy text-center">Ready to Upgrade Your Clinic?</h2>
          
          <div className="bg-white p-10 rounded-3xl border-2 border-bond-lime shadow-xl w-full max-w-2xl mb-10 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-2 bg-bond-lime"></div>
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-bond-lime/10 rounded-full blur-xl"></div>
            
            <div className="flex justify-between items-end mb-8 border-b border-gray-100 pb-6">
              <div>
                <h3 className="text-2xl font-black text-bond-navy mb-2">Standard Package</h3>
                <p className="text-gray-500 font-medium">The perfect high-converting foundation.</p>
              </div>
              <div className="text-right">
                <div className="text-5xl font-black text-bond-navy">₹7,000</div>
              </div>
            </div>

            <div className="space-y-4 mb-10">
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-bond-lime shrink-0 mt-0.5" size={20} />
                <span className="text-lg font-bold text-bond-navy">1 High-Converting Landing Page</span>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-bond-lime shrink-0 mt-0.5" size={20} />
                <span className="text-lg font-bold text-bond-navy">Patient Contact & Booking Forms</span>
              </div>
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-bond-lime shrink-0 mt-0.5" size={20} />
                <span className="text-lg font-bold text-bond-navy">High-Speed Hosting Included</span>
              </div>
              <div className="flex items-start gap-4 opacity-50">
                <span className="text-gray-400 font-black shrink-0 w-[20px] text-center mt-0.5">✕</span>
                <span className="text-lg font-medium text-gray-500 line-through">Multi-Page Architecture</span>
              </div>
              <div className="flex items-start gap-4 opacity-50">
                <span className="text-gray-400 font-black shrink-0 w-[20px] text-center mt-0.5">✕</span>
                <span className="text-lg font-medium text-gray-500 line-through">Premium CSS Particle Animations</span>
              </div>
              <div className="flex items-start gap-4 opacity-50">
                <span className="text-gray-400 font-black shrink-0 w-[20px] text-center mt-0.5">✕</span>
                <span className="text-lg font-medium text-gray-500 line-through">Dynamic Service Pages</span>
              </div>
            </div>

            <a href="https://invictus-ai.in" target="_blank" rel="noopener noreferrer" className="block w-full bg-bond-navy text-white text-center py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-bond-navy/90 transition-colors">
