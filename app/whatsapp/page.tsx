...
export default function WhatsAppBridge() {
  ...
  return (
    <div className="min-h-screen bg-[#ece5dd] flex flex-col items-center justify-center p-4 font-sans">
      {/* WhatsApp Green Icon SVG */}
      <div className="w-24 h-24 mb-6 text-[#25D366] animate-pulse">
      ...
      <p className="text-gray-500 font-medium text-center max-w-sm">
        Securely redirecting you to chat with the Invictus AI team.
      </p>
    </div>
  );
}
